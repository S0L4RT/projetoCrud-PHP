...
<header>
    ...
    <form method="POST">
        <label class="tit" for="titulo">Titulo:</label><br>
        <input class="inserir" type="text" name="titulo" placeholder="Adicionar titulo" required>
        <br><br>
        <label class="not" for="noticia">Notícia:</label><br>
        <textarea cols="50" rows="10" class="inserir" type="text" name="noticia" placeholder="Adicionar noticia" required></textarea>
        <br><br>
