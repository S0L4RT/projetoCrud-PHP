...
class Noticia{
    ...
    public function lerNot($search = '', $order_by = ''){
        $query = "SELECT noticias.idnot, usuarios.nome AS nome_usuario, noticias.data, noticias.titulo, noticias.noticia  FROM noticias INNER JOIN
        usuarios ON noticias.idusu = usuarios.id ";
        $conditions = [];
        $params = [];
