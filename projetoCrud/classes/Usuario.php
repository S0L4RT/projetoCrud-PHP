...
class Usuario{
    private $conn;
    private $table_name = "tbusuario"; // nome da tabela

    public function __construct($conn){
        $this->conn = $conn;
    }

    public function adicionar($nome, $sexo, $fone, $email, $senha){
    ...
    public function criar($nome, $sexo, $fone, $email, $senha){
        return $this->adicionar($nome, $sexo, $fone, $email, $senha);
    }
